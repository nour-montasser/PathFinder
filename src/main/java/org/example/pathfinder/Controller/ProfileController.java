...
public class ProfileController {
    ...
    public void initialize() throws SQLException {
        this.currentUser = userService.authenticateUser(loggedInUser.getEmail(),loggedInUser.getPassword());
        this.usernameEmail.setText(currentUser.getEmail());
        this.userFullName.setText(currentUser.getName());
        this.userRole.setText(currentUser.getRole());
        loadUserProfile();

        if (currentUser.getImage() != null && !currentUser.getImage().isEmpty())
            loadProfilePhoto(currentUser.getImage());

        generateQRCodeUser(currentUser);
    }
