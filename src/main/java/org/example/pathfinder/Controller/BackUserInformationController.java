...
public class BackUserInformationController {
    ...
    public void initializeUser(User user,User currentUser) {
    ...
    private void loadUserProfile() {
        currentProfile = profileService.getOne(this.currentUser.getId());
    ...
    public void UploadImageOnClick(ActionEvent actionEvent) {
        ...
        if (selectedFile != null) {
            try {
                ...
                userService.updateImage(String.valueOf(currentUser.getId()), relativeImagePath);
    ...
    private void changePasswordButtonOnClick(ActionEvent actionEvent) {
        ...
        if (userService.verifyOldPassword(currentUser.getId(),oldPassword)) {
    ...
    void goHome(ActionEvent event) {
        try {
            ...
            ((BackHomeController) controller).initializeUser(userService.getUserByEmail(currentUserEmail.getText()));
    ...
    void goUsers(ActionEvent event) {
        try {
            ...
            loginStage.setTitle("Login"); // Title for the login window
            Object controller = loader.getController();
            ((BackUserController) controller).initializeUser(userService.getUserByEmail(currentUserEmail.getText()));
    ...
    void resetOnClicked(ActionEvent event) {
        try {
            ...
            if(Objects.equals(usernameEmail.getText(), currentUserEmail.getText()))
                this.logOut(event);
            else
                this.goUsers(event);
    ...
    void saveNameButtonOnClick(ActionEvent event) {
        userService.changeUserNameByEmail(usernameEmail.getText(), userFullName.getText());
